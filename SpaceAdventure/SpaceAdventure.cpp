...
// SpaceAdventure.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSpaceAdventureApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSpaceAdventureApp

CSpaceAdventureApp::CSpaceAdventureApp()
{
...
// Единственный объект CSpaceAdventureApp

CSpaceAdventureApp theApp;


// Инициализация CSpaceAdventureApp

BOOL CSpaceAdventureApp::InitInstance()
{
